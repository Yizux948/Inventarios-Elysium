...
def new_supplier_form(right_menu_frame):
    ...
    def validate_new_product():
        ...
        filename = "data/inventory/suppliers.csv"
    ...
    submit = ctk.CTkButton(master=form, text="Registrar proveedor", width=250, font=("Helvetica", 15), command=lambda:validate_new_product()).grid(row=7, column=0, padx=30, pady=35)