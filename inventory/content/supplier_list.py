...
def suppliers_list(right_menu_frame):
    ctk.CTkButton(master=right_menu_frame, 
                  text="Registrar Proveedor", 
                  font=("Helvetica", 15, "bold"),
                  width=200,
                  height=30,                    # frame_a_vaciar, frame_a_colocar
                  command=lambda:chp.new_page(right_menu_frame, "Provedores")
    ...
    product_form = ctk.CTkScrollableFrame(right_menu_frame, width=1110, height=420, corner_radius=10, 
                                                    ...
                                                    label_text="Lista de Proveedores",
                                                    # label_fg_color="blue",
    ...
    data.insert(0, ["Nombre", "Dirección", "Teléfono", "Correo", "Editar", "Eliminar"])
    ...
    def editar_fila(index):
        ...
        chp.new_page_put(right_menu_frame, "Editar Proveedor", index)
    ...
    def eliminar_fila(index):
        ...
        dl_csv.delete_csv("suppliers.csv", right_menu_frame, 'Lista de Proveedores', index)
