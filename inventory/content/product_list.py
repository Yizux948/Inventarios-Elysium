...
def products_list(right_menu_frame):
    ctk.CTkButton(master=right_menu_frame, 
                  text="Registrar Producto", 
                  font=("Helvetica", 15, "bold"),
                  width=200,
                  height=30,                    # frame_a_vaciar, frame_a_colocar
                  command=lambda:chp.new_page(right_menu_frame, "Productos")
    ...
    data.insert(0, ["Nombre", "Descripción", "Precio", "Compra", "Cantidad", "Medida", "Proveedor", "Editar", "Eliminar"])
    ...
    def editar_fila(index):
        ...
        chp.new_page_put(right_menu_frame, "Editar Producto", index)
    ...
    def eliminar_fila(index):
        ...
        dl_csv.delete_csv("products.csv", right_menu_frame, 'Lista de Productos', index)
